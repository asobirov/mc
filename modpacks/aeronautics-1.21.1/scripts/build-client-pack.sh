...
BASE_PACK="$PACK_ROOT/pack/Friends-MC-1.2.0.mrpack"
OUTPUT_PACK="$PACK_ROOT/pack/Friends-MC-1.3.0.mrpack"
RELEASE_FILES="$PACK_ROOT/pack/release-files-1.3.0.json"
