...
- Minecraft: NeoForge 1.21.1, Friends MC pack 1.1.2.
...
`modpacks/aeronautics-1.21.1/pack/Friends-MC-1.1.2.mrpack` is a real ZIP archive,
...
4. Obtain `Friends-MC-1.1.2.mrpack` from the authenticated portal or Git LFS,
   verify the SHA-256 from `pack/README.md`, and import it into an isolated
   instance named `Friends MC 1.1.2`.
